...
class SimpleDropzone {
  ...
  _onDrop(e) {
    ...
    var fileContent = items[0].getAsFile()
    ...
    var file_url = 'https://3dit-model-storage.s3.eu-central-1.amazonaws.com/DamagedHelmet.zip';
    ...
    request(
      { method: "GET",
        ...
        archive.importData64URI(body, (test) => {
          console.log(test)
        });
